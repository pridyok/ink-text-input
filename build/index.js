...
function TextInput({ value: originalValue, placeholder = '', placeholderColor = chalk.grey, focus = true, mask, highlightPastedText = false, showCursor = true, onChange, onSubmit }) {
